package personal.liuwentao.dionysus.sse;
...
public class OpenAiService {
    ...
    public ServerSentEvent createChatCompletionStream(ChatCompletionRequest completionRequest, ServerSentEvent.Listener listener) throws JsonProcessingException {
        completionRequest.setStream(true);
        String requestBody = errorMapper.writeValueAsString(completionRequest);
        RequestBody body = RequestBody.create(MediaType.get("application/json"), requestBody);
